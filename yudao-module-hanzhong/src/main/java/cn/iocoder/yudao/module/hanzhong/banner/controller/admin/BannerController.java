package cn.iocoder.yudao.module.hanzhong.banner.controller.admin;

import cn.iocoder.yudao.framework.common.pojo.CommonResult;
import cn.iocoder.yudao.framework.common.pojo.PageResult;
import cn.iocoder.yudao.module.hanzhong.banner.controller.admin.vo.*;
 ...
 * @author hanzhong
 */
@Tag(name = "管理后台 - 汉中 Banner 管理")
@RestController
@RequestMapping("/hanzhong/banner")
@Validated
public class BannerController {
    ...
    @PreAuthorize("@ss.hasPermission('hanzhong:banner:create')")
    ...
    @PreAuthorize("@ss.hasPermission('hanzhong:banner:update')")
    ...
    @PreAuthorize("@ss.hasPermission('hanzhong:banner:update')")
    public CommonResult<Boolean> updateBannerStatus(@Valid @RequestBody BannerUpdateStatusReqVO updateReqVO) {
        bannerService.updateBannerStatus(updateReqVO.getId(), updateReqVO.getStatus());
        return success(true);
    }
    ...
    @PreAuthorize("@ss.hasPermission('hanzhong:banner:delete')")
    ...
    @GetMapping("/get")
    @Operation(summary = "获得 Banner 详情")
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
    @PreAuthorize("@ss.hasPermission('hanzhong:banner:query')")
